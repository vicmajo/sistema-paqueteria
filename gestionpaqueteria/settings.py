"""
Django settings for gestionpaqueteria project.
...
ALLOWED_HOSTS = ['paqueteria.herokuapp.com', '127.0.0.1', 'localhost', 'paqueteria-22aa5505cdf5.herokuapp.com']
...
ROOT_URLCONF = 'gestionpaqueteria.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'paqueteria' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'gestionpaqueteria.wsgi.application'
